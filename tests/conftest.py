...
_DATE_WINDOW_TEST_FILES = {
    ...
    "test_campaign_claim_balance.py",
    "test_claim_review_queue.py",
    "test_claim_check_staleness.py",
    ...
    "test_content_topic_assignment_gaps.py",
    "test_content_variant_outcomes.py",
    "test_content_variant_freshness.py",
    "test_content_variant_platform_coverage_gaps.py",
    ...
    "test_github_activity_closure_latency.py",
    "test_hotfix_commit_idea_seeder.py",
    "test_image_prompt_reuse.py",
    "test_issue_idea_seeder.py",
    "test_knowledge_author_diversity.py",
    "test_model_usage_stage_budget_burn.py",
    "test_newsletter_click_anomalies.py",
    "test_newsletter_click_content_attribution_gaps.py",
    "test_newsletter_cta_placement.py",
    "test_newsletter_deliverability_preflight.py",
    "test_newsletter_image_placement.py",
    "test_newsletter_image_alt_text_report.py",
    "test_newsletter_intro_click_alignment.py",
    "test_newsletter_reading_time_variance.py",
    "test_newsletter_section_balancer.py",
    "test_newsletter_section_balance.py",
    "test_newsletter_segment_retention_drop.py",
    "test_newsletter_send_source_status_drift.py",
    "test_newsletter_source_reference_audit.py",
    "test_newsletter_subject_selection_regressions.py",
    "test_newsletter_topic_balance.py",
    "test_newsletter_topic_planner.py",
    "test_presence_context.py",
    "test_proactive_action_duplicate_targets.py",
    "test_proactive_action_outcomes.py",
    "test_proactive_action_target_audit.py",
    "test_publication_channel_cooldown_violations.py",
    "test_publication_failure_replay_seed_export.py",
    "test_publication_ledger.py",
    "test_publication_parity.py",
    "test_publication_reliability_streaks.py",
    "test_publication_timezone_drift.py",
    "test_publication_url_audit.py",
    "test_publish_failover.py",
    "test_publish_failure_reasons.py",
    "test_publish_failure_triage.py",
    "test_publish_retry_advisor.py",
    "test_queued_media_readiness.py",
    "test_pipeline_candidate_diversity_gaps.py",
    "test_pipeline_run_artifact_size_growth.py",
    "test_quote_opportunities.py",
    "test_release_coverage.py",
    "test_reply_draft_tone_drift.py",
    "test_reply_duplicate_intent_audit.py",
    "test_redaction_audit.py",
    "test_reply_source_diversity.py",
    ...
    "test_reply_sentiment_drift.py",
    "test_reply_tone_consistency_audit.py",
    "test_restricted_knowledge_usage_audit.py",
    "test_source_overlap.py",
    "test_source_review_backlog.py",
    "test_thread_hook_performance.py",
    "test_visual_alt_text_coverage.py",
    "test_visual_asset_ledger.py",
    "test_x_media_attachment_audit.py",
