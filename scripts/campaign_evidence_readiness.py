#!/usr/bin/env python3
"""Report evidence readiness for upcoming campaign planned topics."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--campaign-id",
        type=int,
        help="Only include planned topics for this campaign.",
    )
    parser.add_argument(
        "--days-ahead",
        type=int,
    ...
    parser.add_argument(
        ...
        help=(
            "Minimum total evidence count for ready status "
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.format == "json":
        print(format_campaign_evidence_readiness_json(report))
    else:
        print(format_campaign_evidence_readiness_text(report))
    return 0
