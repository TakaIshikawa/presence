...
from engagement.reply_question_coverage import (  # noqa: E402
    DEFAULT_DAYS,
    DEFAULT_LIMIT,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.format == "json":
        print(format_reply_question_coverage_json(report))
    else:
        print(format_reply_question_coverage_text(report))
