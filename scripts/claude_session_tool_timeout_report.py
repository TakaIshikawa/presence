...
from ingestion.claude_session_tool_timeout_report import (  # noqa: E402
    DEFAULT_DAYS,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.db:
            with sqlite3.connect(args.db) as conn:
                ...
                report = build_claude_session_tool_timeout_report(
                    conn,
                    days=args.days,
                    tool=args.tool,
                )
    ...
    print(format_claude_session_tool_timeout_json(report))
    return 0
