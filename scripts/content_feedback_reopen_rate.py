#!/usr/bin/env python3
"""Export Content Feedback Reopen Rate."""
from __future__ import annotations
import argparse, sqlite3, sys
from pathlib import Path
sys.path.insert(0, str(Path(__file__).parent.parent / "src"))
from evaluation.content_feedback_reopen_rate import (DEFAULT_WINDOW_DAYS, DEFAULT_MIN_RESOLVED, DEFAULT_LIMIT, build_content_feedback_reopen_rate_report_from_db, format_content_feedback_reopen_rate_json, format_content_feedback_reopen_rate_text)  # noqa: E402
