...
def cmd_promote(db, idea_id: int) -> None:
    """Mark an idea as promoted."""
    db.promote_content_idea(idea_id)
    print(f"Promoted content idea {idea_id}.")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    promote_parser = subparsers.add_parser("promote", help="Mark an idea as promoted")
