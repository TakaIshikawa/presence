#!/usr/bin/env python3
"""Report Claude Code prompts with unresolved contextual references."""
...
from ingestion.claude_unresolved_references import (  # noqa: E402
    DEFAULT_DAYS,
    DEFAULT_LIMIT,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.format == "json":
        print(format_claude_unresolved_references_json(report))
    else:
        print(format_claude_unresolved_references_text(report))
    return 0
