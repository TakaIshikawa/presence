...
from ingestion.claude_session_command_duration_outliers import (  # noqa: E402
    DEFAULT_DAYS,
    DEFAULT_LIMIT,
    DEFAULT_MIN_DURATION_MS,
    build_claude_session_command_duration_outliers_report,
    format_claude_session_command_duration_outliers_json,
    format_claude_session_command_duration_outliers_text,
)
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=f"Minimum duration to report in milliseconds (default: {DEFAULT_MIN_DURATION_MS}).",
    )
    parser.add_argument(
        "--limit",
        type=_positive_int,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.format == "json":
        print(format_claude_session_command_duration_outliers_json(report))
    else:
        print(format_claude_session_command_duration_outliers_text(report))
    return 0
