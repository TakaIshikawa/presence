#!/usr/bin/env python3
"""Audit parsed Claude Code session events for likely secret exposure."""
...
from ingestion.claude_session_secret_exposure_audit import (  # noqa: E402
    DEFAULT_LIMIT,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=f"Maximum evidence snippet length in characters (default: {DEFAULT_SNIPPET_CHARS}).",
    )
    parser.add_argument(
        "--limit",
        type=_positive_int,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        report = build_claude_session_secret_exposure_audit_report(
            rows,
    ...
    print(format_claude_session_secret_exposure_audit_json(report))
    return 0
