#!/usr/bin/env python3
"""Report publication retry-attempt timing buckets by platform."""
...
from evaluation.publication_attempt_latency_buckets import (  # noqa: E402
    DEFAULT_DAYS,
    PLATFORMS,
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.format == "json":
        print(format_publication_attempt_latency_buckets_json(report))
    else:
        print(format_publication_attempt_latency_buckets_text(report))
    return 0
