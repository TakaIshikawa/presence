#!/usr/bin/env python3
"""Plan a balanced weekly newsletter layout without mutating state."""
...
from output.newsletter_section_balancer import (  # noqa: E402
    DEFAULT_DAYS,
    DEFAULT_MAX_ITEMS,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=f"Maximum newsletter items to select (default: {DEFAULT_MAX_ITEMS}).",
    )
    parser.add_argument(
        "--format",
        choices=("text", "json"),
