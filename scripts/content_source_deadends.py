#!/usr/bin/env python3
"""Report generated content whose source chain dead-ends."""
...
from evaluation.content_source_deadends import (  # noqa: E402
    DEFAULT_DAYS,
    DEFAULT_LIMIT,
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--content-type", help="Restrict to one generated_content.content_type.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.json:
        print(format_content_source_deadends_json(report))
    else:
        print(format_content_source_deadends_text(report))
    return 0
