...
from ingestion.claude_session_interruption_resumption import (  # noqa: E402
    DEFAULT_DAYS,
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        if args.db:
            with sqlite3.connect(args.db) as conn:
                ...
                report = build_claude_session_interruption_resumption_report(
                    conn,
                    days=args.days,
                )
        else:
    ...
    print(format_claude_session_interruption_resumption_json(report))
    return 0
